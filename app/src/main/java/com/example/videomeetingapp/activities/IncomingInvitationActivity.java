...
public class IncomingInvitationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imageMetingType = findViewById(R.id.imageMeetingType);
        //get data from intent messagingService
         meetingType = getIntent().getStringExtra(Constants.REMOTE_MSG_MEETING_TYPE);
        if(meetingType != null){
            if(meetingType.equals("video")){
                imageMetingType.setImageResource(R.drawable.ic_video);
            } else {
                imageMetingType.setImageResource(R.drawable.ic_audio);
            }
        }
    ...
    private void sendRemoteMessage( String remoteMessageBody, String type) { //two argument required body and type
